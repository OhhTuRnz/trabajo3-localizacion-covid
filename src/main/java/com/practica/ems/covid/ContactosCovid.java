...
public class ContactosCovid {
	...
	private void tratarDatos(String[] datos) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException,
	...
	private void aniadirPersona(String[] datos) throws Exception
	{
	...
	private void aniadirLocalizacion(String[] datos) throws Exception{
		if (datos.length != Constantes.MAX_DATOS_LOCALIZACION) {
	...
	private void checkPersonaLocalizacion(String[] datas) throws Exception
	{
		for (String linea : datas) {
			String datos[] = this.dividirLineaData(linea);
			if (!datos[0].equals("PERSONA") && !datos[0].equals("LOCALIZACION")) {
	...
	public void loadDataFile(String fichero, boolean reset) {
		...
		try {
			...
			while ((data = br.readLine()) != null) {
				...
				checkPersonaLocalizacion(datas);
